...
$(document).ready(function () {
    ...
    $(document).on({
        ajaxStart: function () {
            loadSpin.addClass("loadingOn");
        },
        ajaxStop: function () {
            loadSpin.removeClass("loadingOn");
        }
    });
        ...
        */
        ...
        PB: {
            ...
            advertisements: {
                ...
                10: {
                    name: 'PB11',
                    description: 'Micro-Water Filter Used By Paratroopers Becoming Very Popular',
                    link: 'http://secure.ultracart.com/aff/F51BB15AF89F0F0150AA3582DA051500/index.html?subid=',
                    template: 'PB11'
                }
            }
        }
        ...
        stripTagsFromDescription: function (description) {  //strips extraneous html tags from the story
            if (description !== null && description !== undefined) {
                ...
                var stripDesc = S(desc).stripTags('span', 'div', 'center', 'img', 'html', 'script', 'iframe', 'a', 'meta',
                    ...
                    'h5', 'link', 'header', 'label', 'person', 'location', 'org', 'chron', 'video', 'pre').s;
                /**
